...
import { formatTimeString, parseTimeString } from "../lib/constants/playlist-form";
...
export function FormTimePicker({
  ...
  const timeValue = parseTimeString(value || "09:00");
  ...
  return (
    <View className="mb-3">
      ...
      >
        <Text className="text-white">{value || "Select time"}</Text>
      </Pressable>
